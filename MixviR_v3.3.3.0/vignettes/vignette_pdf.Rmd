...
output: 
  rmarkdown::pdf_document:
    toc: true
vignette: >
  %\VignetteIndexEntry{MixviR_v3.3.3}
...
knitr::include_graphics("../inst/images/Fig1.jpg")
```
...
knitr::include_graphics("../inst/images/Fig2.jpg")
```
...
knitr::include_graphics("../inst/images/Fig3.jpg")
```
...
knitr::include_graphics("../inst/images/Fig6.jpg")
```
...
knitr::include_graphics("../inst/images/Fig7.jpg")
```
...
knitr::include_graphics("../inst/images/Fig8.jpg")
...
knitr::include_graphics("../inst/images/Fig9.jpg")
```
<br><br><br><br><br>
...
knitr::include_graphics("../inst/images/Fig10.jpg")
```
...
knitr::include_graphics("../inst/images/Fig11.jpg")
```
...
knitr::include_graphics("../inst/images/Fig12.jpg")
```
...
knitr::include_graphics("../inst/images/Fig13.jpg")
```
...
knitr::include_graphics("../inst/images/Fig14.jpg")
```
...
knitr::include_graphics("../inst/images/Fig15.jpg")
```
...
knitr::include_graphics("../inst/images/Fig16.jpg")
```
...
knitr::include_graphics("../inst/images/Fig17.jpg")
```
...
knitr::include_graphics("../inst/images/Fig18.jpg")
```
...
knitr::include_graphics("../inst/images/Fig19.jpg")
```
...
knitr::include_graphics("../inst/images/Fig20.jpg")
```
