...
#' @keywords mutation
#' @return Object 'samp_mutations' stored in the global environment. Specifically, a data frame containing variants observed for each sample, positions of the underlying mutations, and other (customizable) information.
#' @export
#' @examples
#' call_mutations(sample.dir = system.file("extdata", "vcfs", package = "MixviR"), 
#'                name.sep = "_", reference = "Wuhan")
#' call_mutations(sample.dir = system.file("extdata", "vcfs", package = "MixviR"), 
#'                name.sep = "_", reference = "Wuhan", write.mut.table = TRUE)
#' call_mutations(sample.dir = system.file("extdata", "vcfs", package = "MixviR"), 
#'  name.sep = "_", 
#'  fasta.genome="https://raw.githubusercontent.com/mikesovic/MixviR/main/raw_files/GCF_009858895.2_ASM985889v3_genomic.fna",
#'  bed = "https://raw.githubusercontent.com/mikesovic/MixviR/main/raw_files/sars_cov2_genes.bed")
