...
output: 
  rmarkdown::pdf_document:
    toc: true
vignette: >
  %\VignetteIndexEntry{MixviR_v3.3.4.0}
...
```{r echo=FALSE, out.width='50%', fig.cap="Example lineage-associated mutation file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig1.jpg", "Fig1.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='50%', fig.cap="Example location/date file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig2.jpg", "Fig2.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='60%', fig.cap="Example features (bed) input file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig3.jpg", "Fig3.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='60%', fig.cap="Example lineage-associated mutation file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig1.jpg", "Fig1.jpg", mode = 'wb')
knitr::include_graphics("Fig1.jpg")
```
...
```{r echo=FALSE, out.width='60%', fig.cap="Example location/date file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig2.jpg", "Fig2.jpg", mode = 'wb')
knitr::include_graphics("Fig2.jpg")
```
...
```{r echo=FALSE, out.width='100%', fig.cap="Example of the initial MixviR reference object. Two non-genic positions and 6 genic positions, representing 2 amino acids, are shown."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig6.jpg", "Fig6.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="MixviR reference object with sequencing depths for the sample being analyzed added in the DP column. NA in this column indicates the position was not included in the input vcf file."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig7.jpg", "Fig7.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="Example set of variants from a sample being analyzed after filtering for the default minimum allele frequency of 1\\%. Deletions have length >1bp in the REF column, while insertions have length >1bp in the ALT column. Variants are merged with the reference to create a sample genome that is translated to identify amino acid changes."}

download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig8.jpg", "Fig8.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="Example set of SNP-based mutations. Synonymous and non-synonymous mutations in two different genes, and a mutation in a non-genic region, are included."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig9.jpg", "Fig9.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="Example insertions and deletions called from a sample during a MixviR anaysis. Deletions are indicated with 'del' in the name, and insertions with 'ins' - see samp\\_identity column for examples."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig10.jpg", "Fig10.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='80%', fig.cap="The samp\\_mutations data frame is the primary output of the call\\_mutations() function."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig11.jpg", "Fig11.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="'View Mutations' RShiny tab."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig12.jpg", "Fig12.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="'New Mutations' RShiny tab. The displayed mutations were first observed on or after the selected date."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig13.jpg", "Fig13.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="'Mutation Frequencies' RShiny tab displaying frequencies of specific mutations over time."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig14.jpg", "Fig14.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="'Variants Present' RShiny tab after adjusting the threshold for calling a lineage as present, and now only identifying P.1 as present in the 2021-05-02 sample."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig16.jpg", "Fig16.jpg", mode = 'wb')
knitr::include_graphics("Fig16.jpg")
```
...
```{r echo=FALSE, out.width='100%', fig.cap="Example of a tooltip on Lineages Present plot."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig17.jpg", "Fig17.jpg", mode = 'wb')
knitr::include_graphics("Fig17.jpg")
```
...
```{r echo=FALSE, out.width='90%', fig.cap="Example tooltop on lineage frequency plot."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig18.jpg", "Fig18.jpg", mode = 'wb')
knitr::include_graphics("Fig18.jpg")
```
...
```{r echo=FALSE, out.width='70%', fig.cap="Example of the samp\\_mutations data frame when the write.all.muts option is used to include sequencing depths for mutations not observed in the sample."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig19.jpg", "Fig19.jpg", mode = 'wb')
...
```{r echo=FALSE, out.width='100%', fig.cap="Example tooltip in explore\\_mutations() run with all.target.muts set to TRUE."}
download.file("https://raw.githubusercontent.com/mikesovic/MixviR/main/MixviR_v3.3.4/inst/images/Fig20.jpg", "Fig20.jpg", mode = 'wb')
